...
def number_of_unexplored_paths(room):
    unexplored_count = 0
...
def initial_dict_entry_value(visited, room):
...
# traversal_path = ['n', 'n']
traversal_path = traversal_directions(world, player)
